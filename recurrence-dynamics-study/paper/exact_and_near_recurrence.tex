...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.98\linewidth]{figures/hpp_ambiguity_cycle_pair.png}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.76\linewidth]{figures/square_lattice_microscopic_damage.png}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.76\linewidth]{figures/hexagonal_rotor_damage.png}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.76\linewidth]{figures/elastic_ring_pair_distance.png}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.76\linewidth]{figures/irrational_torus_return_error.png}
